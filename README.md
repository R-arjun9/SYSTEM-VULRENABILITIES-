...
- **Backend:** Python (Flask Security API Server)
...
The project includes a `run.bat` file that automatically sets up the Python environment, installs dependencies, and launches both the backend and frontend.
...
- The **Python Flask Server** acts as a bridge between the React frontend and the system scripts.
